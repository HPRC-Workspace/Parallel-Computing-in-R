...
result <- mclapply(numbers, sqrt_parallel)
...
In the code chunk below, create a list named my_list containing the numbers 121, 144, 169, 196, and 225. Write a function named cube_root that calculates the cube root of each number in the list. Use mclapply() to apply the function to the list in parallel. Print the result.
